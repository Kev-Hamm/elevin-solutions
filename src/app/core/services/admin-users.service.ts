...
export class AdminUsersService {
  ...
  requirePasswordReset(userId: string): Observable<{ message: string }> {
    return this.http.post<{ message: string }>(`${this.apiUrl}/admin/users/${userId}/require-password-reset`, {});
  }
}
