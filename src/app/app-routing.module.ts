...
import { RequiredPasswordResetComponent } from './features/auth/required-password-reset/required-password-reset.component';
...
import { AboutUsComponent } from './features/public/about-us.component';
...
export const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent },
  {
    ...
    children: [
      ...
      { path: 'reset-password', component: RequiredPasswordResetComponent, canActivate: [authGuard] },
